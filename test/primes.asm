g_declare_globals gm$cons_0_0, 0, gm$cons_0_1, 1, gm$cons_0_2, 2, gm$cons_0_4, 4, gm$cons_1_0, 0, gm$cons_1_2, 2, gm$abort, 0, gm$eq, 2, gm$lt, 2, gm$le, 2, gm$ge, 2, gm$gt, 2, gm$neg, 1, gm$add, 2, gm$sub, 2, gm$mul, 2, gm$mod, 2, gm$seq, 2, gm$puti, 1, gm$geti, 1, dict$Eq$Int, 0, dict$Ord$Int, 0, dict$Ring$Int, 0, dict$Foldable$List, 0, dict$Monad$IO, 0, input, 0, psums, 0, primes, 0, main, 0, eq$ll1, 1, neq$ll1, 3, le$ll1, 1, append$ll1, 1, add$ll1, 1, sub$ll1, 1, foldr$ll1, 1, foldl$ll1, 1, dict$Monoid$List$ll1, 2, dict$Monoid$List$ll2, 0, dict$Foldable$List$ll1, 3, dict$Foldable$List$ll2, 3, nth_exn$ll1, 2, bind$ll1, 1, dict$Monad$IO$ll1, 0, dict$Monad$IO$ll2, 1, dict$Monad$IO$ll3, 3, dict$Monad$IO$ll4, 2, io$ll1, 3, io$ll2, 2, print$ll1, 0, repeat$ll1, 1, psums$ll1, 4, filter$ll1, 3, filter$ll2, 1, sieve$ll1, 2, sieve$ll2, 1, main$ll1, 1
g_declare_main main
