g_declare_cafs gm$cons_0_0, gm$cons_1_0, gm$abort, dict$Eq$Int, dict$Ord$Int, dict$Ring$Int, dict$Foldable$List, dict$Monad$IO, input, psums, primes, main, print$ll1
g_declare_main main
