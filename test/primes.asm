g_declare_globals C.0.0, 0, C.0.1, 1, C.0.2, 2, C.0.4, 4, C.1.0, 0, C.1.2, 2, B.abort, 0, B.eq, 2, B.lt, 2, B.le, 2, B.ge, 2, B.gt, 2, B.neg, 1, B.add, 2, B.sub, 2, B.mul, 2, B.mod, 2, B.seq, 2, B.puti, 1, B.geti, 1, eq, 1, le, 1, append, 1, add, 1, sub, 1, eqInt, 0, ordInt, 0, ringInt, 0, foldr, 1, foldl, 1, monoidList, 0, foldableList, 0, bind, 1, monadIO, 0, print, 0, input, 0, psums, 0, sieve, 1, primes, 0, main, 0, monoidList.empty, 0, neq.L1, 3, monoidList.append.L1, 2, foldableList.foldr.L1, 3, foldableList.foldl.L1, 3, nth_exn.L1, 2, monadIO.pure.L1, 0, monadIO.pure.L2, 1, monadIO.bind.L1, 3, monadIO.bind.L2, 2, io.L1, 3, io.L2, 2, repeat.L1, 1, psums.L1, 4, filter.L1, 3, filter.L2, 1, sieve.L1, 2, main.L1, 1
g_declare_main main
