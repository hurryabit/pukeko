...
and when p m = if p then m else return Unit
and count_down k = when (k>=0) (print k;count_down (k-1))
and repeat_m k m = when (k>0) (m;repeat_m (k-1) m)
and main$2 k n = repeat_m k (count_down n)
and main$1 k = input>>=main$2 k
