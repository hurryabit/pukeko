g_declare_globals gm$cons_0_0, 0, gm$cons_0_2, 2, gm$cons_1_2, 2, gm$abort, 0, gm$le, 2, gm$add, 2, gm$sub, 2, gm$mul, 2, gm$mod, 2, gm$seq, 2, gm$puti, 1, gm$geti, 1, input, 0, p, 0, sum_p, 0, sols, 0, main, 0, dict$Functor$List$ll1, 2, dict$Foldable$List$ll2, 3, nth_exn$ll1, 2, zip_with$ll1, 3, dict$Monad$IO$ll3, 3, io$ll1, 3, io$ll2, 2, print$ll1, 0, mul_p$ll1, 2, add_p$ll1, 2, scanl$ll1, 4, sols$ll1, 1, sols$ll2, 2, main$ll1, 1
g_declare_main main
