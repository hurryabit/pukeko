g_declare_cafs gm$cons_0_0, gm$abort, dict$Ord$Int, dict$Ring$Int, dict$Functor$List, dict$Foldable$List, dict$Monad$IO, input, p, sum_p, sols, main, print$ll1
g_declare_main main
