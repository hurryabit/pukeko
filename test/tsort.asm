g_declare_cafs gm$cons_0_0, bag_empty, dict$Foldable$Bag, dict$Foldable$BinTree, dict$Foldable$List, dict$Monad$IO, dict$Monad$IO$ll1, dict$Ord$Int, dict$Ring$Int, input, main
g_declare_main main
