g_declare_cafs gm$cons_0_0, dict$Ord$Int, dict$Ring$Int, dict$Foldable$List, dict$Monad$IO$ll1, dict$Monad$IO, input, dict$Foldable$BinTree, dict$Foldable$Bag, bag_empty, main
g_declare_main main
...
g_pushglobal dict$Foldable$BinTree$ll1, 3
g_pushglobal dict$Foldable$BinTree$ll2, 3
g_push 0
g_push 2
g_updcons 0, 2, 3
g_pop 2
...
g_pushglobal dict$Foldable$Bag$ll1, 3
g_pushglobal dict$Foldable$Bag$ll2, 3
g_push 0
g_push 2
g_updcons 0, 2, 3
g_pop 2
