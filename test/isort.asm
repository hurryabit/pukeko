g_declare_cafs gm$cons_0_0, dict$Ord$Int, dict$Ring$Int, dict$Foldable$List, dict$Monad$IO, input, main, dict$Monad$IO$ll1, print$ll1
g_declare_main main
