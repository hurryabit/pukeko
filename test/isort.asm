g_declare_globals gm$cons_0_0, 0, gm$cons_0_2, 2, gm$cons_1_2, 2, gm$le, 2, gm$sub, 2, gm$seq, 2, gm$puti, 1, gm$geti, 1, dict$Monad$IO, 0, input, 0, main, 0, dict$Foldable$List$ll1, 3, replicate$ll1, 2, semi$ll1, 2, semi$ll2, 3, sequence$ll1, 3, sequence$ll2, 3, sequence$ll3, 2, traverse_$ll1, 3, dict$Monad$IO$ll2, 1, dict$Monad$IO$ll3, 3, dict$Monad$IO$ll4, 2, io$ll1, 3, io$ll2, 2, print$ll1, 0, insert$ll1, 2, isort$ll1, 1, main$ll1, 1, main$ll2, 1
g_declare_main main
