g_declare_cafs gm$cons_0_0, dict$Bifunctor$ListF, dict$Foldable$List, dict$Functor$ListF, dict$Monad$IO, dict$Monad$IO$ll1, dict$Ord$Int, dict$Ring$Int, fromList, input, main, toList
g_declare_main main
