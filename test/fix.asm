g_declare_cafs gm$cons_0_0, dict$Ord$Int, dict$Ring$Int, dict$Foldable$List, dict$Monad$IO, input, dict$Bifunctor$ListF, main, print$ll1, dict$Functor$ListF$ll1, main$ll1
g_declare_main main
