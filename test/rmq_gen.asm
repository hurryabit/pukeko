g_declare_globals C.0.0, 0, C.0.2, 2, C.0.4, 4, C.1.2, 2, B.lt, 2, B.le, 2, B.ge, 2, B.gt, 2, B.neg, 1, B.add, 2, B.sub, 2, B.mul, 2, B.mod, 2, B.seq, 2, B.puti, 1, ordInt, 0, ringInt, 0, foldableList, 0, monadIO, 0, print, 0, random, 0, main, 0, foldableList.foldr.L1, 3, foldableList.foldl.L1, 3, take.L1, 2, zip_with.L1, 3, semi.L1, 2, semi.L2, 3, sequence.L1, 3, sequence.L2, 3, sequence.L3, 2, traverse_.L1, 3, monadIO.pure.L2, 1, monadIO.bind.L1, 3, monadIO.bind.L2, 2, io.L1, 3, io.L2, 2, gen.L1, 2, split_at.L1, 2, random.L1, 1, main.L1, 3, main.L2, 1
g_declare_main main
