g_declare_globals C.0.0, 0, C.0.1, 1, C.0.2, 2, C.0.4, 4, C.1.2, 2, B.eq, 2, B.lt, 2, B.le, 2, B.ge, 2, B.gt, 2, B.neg, 1, B.add, 2, B.sub, 2, B.mul, 2, B.seq, 2, B.puti, 1, B.geti, 1, eqInt, 0, ordInt, 0, ringInt, 0, monoidInt, 0, functorList, 0, foldableList, 0, monadIO, 0, print, 0, input, 0, ints, 0, solve_aux, 1, main, 0, monoidInt.empty, 0, monoidList.empty, 0, foldMap.L1, 3, length.L1, 1, monoidList.append.L1, 2, functorList.map.L1, 2, foldableList.foldr.L1, 3, foldableList.foldl.L1, 3, take.L1, 2, replicate.L1, 2, zip_with.L1, 3, monadIO.pure.L2, 1, monadIO.bind.L1, 3, monadIO.bind.L2, 2, io.L1, 3, io.L2, 2, diff.L1, 2, ints.L1, 2, solve_aux.L1, 3, solve_aux.L2, 2, main.L1, 1
g_declare_main main
