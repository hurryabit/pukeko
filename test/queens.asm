g_declare_cafs gm$cons_0_0, dict$Eq$Int, dict$Foldable$List, dict$Functor$List, dict$Monad$IO, dict$Monad$IO$ll1, dict$Monoid$Int, dict$Monoid$List, dict$Ord$Int, dict$Ring$Int, input, ints, main
g_declare_main main
