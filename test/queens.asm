g_declare_cafs gm$cons_0_0, dict$Eq$Int, dict$Ord$Int, dict$Ring$Int, dict$Monoid$Int, dict$Monoid$List, dict$Functor$List, dict$Foldable$List, dict$Monad$IO$ll1, dict$Monad$IO, input, ints, main
g_declare_main main
...
g_globstart foldMap, 3
g_push 0
g_pushglobal empty, 1
g_mkap 1
g_push 3
g_push 2
