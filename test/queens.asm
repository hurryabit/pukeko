g_declare_cafs gm$cons_0_0, dict$Eq$Int, dict$Ord$Int, dict$Ring$Int, dict$Monoid$Int, dict$Monoid$List, dict$Functor$List, dict$Foldable$List, dict$Monad$IO, ints, main
g_declare_main main
