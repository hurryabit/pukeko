g_declare_globals C.0.0, 0, C.0.2, 2, C.0.4, 4, C.1.2, 2, B.lt, 2, B.le, 2, B.ge, 2, B.gt, 2, B.neg, 1, B.add, 2, B.sub, 2, B.mul, 2, B.seq, 2, B.puti, 1, B.geti, 1, le, 1, lt, 1, append, 1, sub, 1, ordInt, 0, ringInt, 0, foldr, 1, foldl, 1, monoidList, 0, foldableList, 0, pure, 1, bind, 1, monadIO, 0, print, 0, input, 0, qsort, 1, main, 0, monoidList.empty, 0, monoidList.append.L1, 2, foldableList.foldr.L1, 3, foldableList.foldl.L1, 3, replicate.L1, 2, partition.L1, 2, semi.L1, 2, semi.L2, 3, sequence.L1, 3, sequence.L2, 3, sequence.L3, 2, traverse_.L1, 3, traverse_.L2, 3, monadIO.pure.L1, 0, monadIO.pure.L2, 1, monadIO.bind.L1, 3, monadIO.bind.L2, 2, io.L1, 3, io.L2, 2, qsort.L1, 2, main.L1, 1, main.L2, 1
g_declare_main main
