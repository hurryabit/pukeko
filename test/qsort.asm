g_declare_globals gm$cons_0_0, 0, gm$cons_0_2, 2, gm$cons_0_4, 4, gm$cons_1_2, 2, gm$lt, 2, gm$le, 2, gm$ge, 2, gm$gt, 2, gm$neg, 1, gm$add, 2, gm$sub, 2, gm$mul, 2, gm$seq, 2, gm$puti, 1, gm$geti, 1, dict$Ord$Int, 0, dict$Ring$Int, 0, dict$Foldable$List, 0, dict$Monad$IO, 0, input, 0, main, 0, le$ll1, 1, lt$ll1, 1, append$ll1, 1, sub$ll1, 1, foldr$ll1, 1, foldl$ll1, 1, dict$Monoid$List$ll1, 2, dict$Monoid$List$ll2, 0, dict$Foldable$List$ll1, 3, dict$Foldable$List$ll2, 3, replicate$ll1, 2, partition$ll1, 2, pure$ll1, 1, bind$ll1, 1, semi$ll1, 2, semi$ll2, 3, sequence$ll1, 3, sequence$ll2, 3, sequence$ll3, 2, traverse_$ll1, 3, traverse_$ll2, 3, dict$Monad$IO$ll1, 0, dict$Monad$IO$ll2, 1, dict$Monad$IO$ll3, 3, dict$Monad$IO$ll4, 2, io$ll1, 3, io$ll2, 2, print$ll1, 0, qsort$ll1, 2, qsort$ll2, 1, main$ll1, 1, main$ll2, 1
g_declare_main main
...
g_pushglobal qsort$ll2
g_mkap 1
g_pushglobal dict$Monoid$List$ll2
g_pushglobal append$ll1
g_updap 3, 6
g_pop 5
g_unwind
g_label .2
