g_declare_globals gm$cons_0_0, 0, gm$cons_0_2, 2, gm$cons_1_2, 2, gm$abort, 0, gm$lt, 2, gm$le, 2, gm$add, 2, gm$sub, 2, gm$mul, 2, gm$seq, 2, gm$puti, 1, gm$geti, 1, input, 0, prime, 0, fibs0, 0, fibs1, 0, main, 0, nth_exn$ll1, 2, zip_with$ll1, 3, dict$Monad$IO$ll3, 3, io$ll1, 3, io$ll2, 2, print$ll1, 0, add_mod_prime$ll1, 2, main$ll1, 1
g_declare_main main
