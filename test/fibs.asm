g_declare_globals C.0.0, 0, C.0.2, 2, C.0.4, 4, C.1.2, 2, B.abort, 0, B.lt, 2, B.le, 2, B.ge, 2, B.gt, 2, B.neg, 1, B.add, 2, B.sub, 2, B.mul, 2, B.seq, 2, B.puti, 1, B.geti, 1, ordInt, 0, ringInt, 0, monadIO, 0, input, 0, prime, 0, fibs0, 0, fibs1, 0, main, 0, le.L1, 1, lt.L1, 1, add.L1, 1, sub.L1, 1, mul.L1, 1, nth_exn.L1, 2, zip_with.L1, 3, bind.L1, 1, monadIO.pure.L1, 0, monadIO.pure.L2, 1, monadIO.bind.L1, 3, monadIO.bind.L2, 2, io.L1, 3, io.L2, 2, print.L1, 0, add_mod_prime.L1, 2, main.L1, 1
g_declare_main main
