g_declare_cafs gm$cons_0_0, gm$abort, dict$Monad$IO, dict$Monad$IO$ll1, dict$Ord$Int, dict$Ring$Int, fibs0, fibs1, input, main, prime
g_declare_main main
...
g_pushglobal add_mod_prime$ll1, 2
