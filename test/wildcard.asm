g_declare_globals gm$cons_0_0, 0, gm$cons_0_2, 2, gm$seq, 2, gm$puti, 1, gm$geti, 1, dict$Monad$IO, 0, input, 0, main, 0, semi$ll1, 2, dict$Monad$IO$ll2, 1, dict$Monad$IO$ll3, 3, dict$Monad$IO$ll4, 2, io$ll1, 3, io$ll2, 2, print$ll1, 0, main$ll1, 2, main$ll2, 1
g_declare_main main
