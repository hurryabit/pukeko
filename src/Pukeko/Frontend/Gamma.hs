...
withKinds ::
  ...
  EnvLevelOf i (Set Id.TCls) -> GammaT (TScope i tv) ev m a -> GammaT tv ev m a
...
lookupKind :: (HasEnv tv, Monad m) => tv -> GammaT tv ev m (Set Id.TCls)
