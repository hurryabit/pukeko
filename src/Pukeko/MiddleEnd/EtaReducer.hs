    ...
    case e0 of
      ...
      EApp (traverse strengthenScope -> Just e1) (traverse _EVar -> Just xs1)
        ...
        , iall (\i -> scope absurd (== i)) xs1 ->
          erSupCDecl (SupCDecl z vs0 t0 [] (weakenE e1))
      ...
      ETyApp
        ...
        , iall (\i -> scope absurd (== i)) vs1 ->
          SupCDecl z [] (weakenT (mkTUni vs0 t0)) [] (bimap weakenScope weakenScope e1)
      ...
      ETyAbs vs1 e1
        ...
        , length vs1 == length vs2 ->
            let e2, e3 :: Expr (TScope Int Void) (EScope Int Void)
            ...
            in  erSupCDecl (SupCDecl z vs2 t2 [] e3)
      ELoc e1 -> erSupCDecl (SupCDecl z vs0 t0 bs0 (e1^.lctd))
      _ -> supc
